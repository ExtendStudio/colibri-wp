...
class PluginMessageControl extends VueControl {
	...
	protected function printVueContent() {
        ...
        <div class="plugin-message card">
            ...
            <a href="<?php echo esc_attr( colibriwp_companion_plugin_link() ); ?>" target="_blank"
               class="el-button el-link h-col el-button--primary el-button--small" style="text-decoration: none">
