...
class HeroStyle extends PartialComponent {
	...
	public function getDividerSettings( $prefix ) {
		...
		return array(
			...
			"{$divider_prefix}enabled" => array(
				'default' => (int) Defaults::get( "{$divider_prefix}enabled" ),
				'control' => array(
	...
	protected function getGeneralBackgroundSettings( $prefix ) {
		...
		return array(
			...
			"{$prefix}full_height" => array(
				'default'    => (int) Defaults::get( "{$prefix}full_height" ),
				'control'    => array(
	...
	protected function getImageSettings( $prefix ) {
		...
		return array(
			"{$image_prefix}source.url" => array(
				'default'      => get_template_directory_uri() . "/resources/images/" . Defaults::get( "{$image_prefix}source.url",
						"" ),
				'control'      => array(
	...
	protected function getSpacingSettings( $prefix ) {
		return array(
			...
			"{$prefix}style.padding.sides.top" => array(
				'default'    => Defaults::get( "{$prefix}style.padding.sides.top", 150 ),
				'transport'  => 'postMessage',
				'control'    => array(
			...
			"{$prefix}style.padding.sides.bottom" => array(
				'default'    => Defaults::get( "{$prefix}style.padding.sides.bottom", 150 ),
				'transport'  => 'postMessage',
				'control'    => array(
