...
class HeroBackground extends PartialComponent {
	...
	protected function getGeneralBackgroundSettings( $prefix ) {
		...
		return array(
			...
			"{$prefix}style.padding" => array(
				...
				'control'      => array(
					'label'       => Translations::get( 'spacing' ),
					'type'        => 'spacing',
					'section'     => 'hero',
					'colibri_tab' => 'style',
				),
				'css_output'   => array(
					array(
						...
						'media'         => CSSOutput::NO_MEDIA,
						'property'      => 'padding',
						'value_pattern' => '#sides.top##unit# 0 #sides.bottom##unit# 0',
					),
				),
				'active_rules' => array(
					array(
