...
$colibri_theme_divider_style = array(
	'arrow-negative'                 => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 10" preserveAspectRatio="none">' .
	                                    '	<path d="M360 0L350 9.9 340 0 0 0 0 10 700 10 700 0"/>' .
	                                    '</svg>',
	...
	'opacity-fan'                    => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 283.5 19.6" preserveAspectRatio="none">' .
	                                    '	<path opacity="0.33"  d="M0 0L0 18.8 141.8 4.1 283.5 18.8 283.5 0z"/>' .
	                                    '	<path opacity="0.33" d="M0 0L0 12.6 141.8 4 283.5 12.6 283.5 0z"/>' .
	                                    '	<path opacity="0.33" d="M0 0L0 6.4 141.8 4 283.5 6.4 283.5 0z"/>' .
	...
	'opacity-tilt'                   => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2600 131.1" preserveAspectRatio="none">' .
	                                    ...
	                                    '	<path opacity="0.5" d="M0 0L2600 0 2600 69.1 0 69.1z"/>' .
	                                    '	<path opacity="0.25" d="M2600 0L0 0 0 130.1 2600 69.1z"/>' .
	                                    '</svg>',
